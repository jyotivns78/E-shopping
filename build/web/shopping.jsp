        ...
        <section id="header">
            ...
            <div>
                <ul id="navbar">
                    ...
                    <li><a class="active" href="shopping.html">Shop</a></li>
...
<!--                        <div class="total">
    ...
    position: absolute;
    bottom: 20px;
    right: 10px;" class="fa fa-shopping-cart cart" id="cart"></i>
                    </div>
                    </div>
                    </div>
                    </div>
...
function renderTable() {
    ...
    shoppingPros.forEach(product => {
        ...
        card.querySelector(".card-text").innerHTML = product.price
         ...
         addCart.addEventListener("click", () => console.log(product.id));
