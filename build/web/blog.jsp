<%-- 
    Document   : blog
    Created on : 4 Sep, 2022, 2:34:35 AM
    Author     : Jyoti
--%>
        ...
        <section id="header">
            ...
            <div>
                <ul id="navbar">
                    ...
                    <li><a href="shopping.jsp.jsp">Shop</a></li>
        ...
        <section id="blog">
            <div class="blog-box">
                ...
                <div class="blog-details">
                    ...
                    <p>Kickstarter man braid godard coloring book, Reclette waistcost selfies
                    yr wolf charteuse hexagon irony, godard......</p>
