    ...
    <body>
		...
		<div class="left">
			<h3>BILLING ADDRESS</h3>
				...
				Email
                                <input type="text" name="email" placeholder="Enter email" onkeydown="emailValidate()" id="email">
				...
				<div id="zip">
					<label>
						...
						<label>
						Zip code
                                                <input type="number" name="" placeholder="Zip code" id="code">
					</label>
				</div>
			</form>
		</div>
				...
				<div id="zip">
					...
					<label>
						...
						CVV
                                ...
                                <br>
                                <button class="normal" onclick="clickOn();">Proceed to Checkout</button>
                                <a href="User_Data.jsp">newlink</a>
                        </form>
